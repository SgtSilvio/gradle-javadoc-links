...
class ConfigurationCacheTest {
    ...
    fun configurationCacheReused() {
        ...
        projectDir.resolve("build.gradle.kts").writeText(
            ...
            dependencies {
                api("group:included-test") // javadocElements configuration
        ...
        assertEquals(TaskOutcome.SUCCESS, result.task(":included-project:javadoc")?.outcome)
        ...
        assertTrue(lines[1].matches(Regex("-linkoffline https://javadoc\\.io/doc/group/included-test/0\\.1\\.0/ .*/build/tmp/javadocLinks/group/included-test/0\\.1\\.0")))
        assertTrue(lines[2].matches(Regex("-linkoffline https://javadoc\\.io/doc/com\\.hivemq/hivemq-extension-sdk/4\\.7\\.0/ .*/build/tmp/javadocLinks/com\\.hivemq/hivemq-extension-sdk/4\\.7\\.0")))
        assertTrue(lines[3].matches(Regex("-linkoffline https://javadoc\\.io/doc/io\\.netty/netty-handler/4\\.1\\.68\\.Final/ .*/build/tmp/javadocLinks/io\\.netty/netty-handler/4\\.1\\.68\\.Final")))
        ...
        assertEquals(TaskOutcome.UP_TO_DATE, result2.task(":included-project:javadoc")?.outcome)
